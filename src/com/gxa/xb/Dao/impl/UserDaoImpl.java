...
public class UserDaoImpl implements UserDao {
	...
	public UserInfo selectUserByUserId(int userId) {
		...
		return (UserInfo) JDBCUtil.executeQueryOne(sql, new UserInfoMapping(), userId);
	}
	...
	public UserInfo userLogin(UserInfo user) {
		...
		UserInfo userInfo = (UserInfo) JDBCUtil.executeQueryOne(sql, new UserInfoMapping(), user.getUserName(),user.getUserPwd());
		if(userInfo != null){
			return userInfo;
		}
		return null;
